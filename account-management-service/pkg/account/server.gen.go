...
type ServerInterface interface {
	...
	// Get account interest details by customer ID
	// (GET /internal/accounts/{customerId}/interest-details)
	GetInterestDetails(c *gin.Context, customerId string, params GetInterestDetailsParams)
}
...
func (siw *ServerInterfaceWrapper) GetInterestDetails(c *gin.Context) {
	...
	var params GetInterestDetailsParams
	...
	siw.Handler.GetInterestDetails(c, customerId, params)
}
